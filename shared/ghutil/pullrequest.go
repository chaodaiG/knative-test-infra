...
// GetPullRequest updates PullRequest, passing head user and branch name "user:ref-name", and base branch name like "master"
...
// UpdatePullRequest updates PullRequest, passing head user and branch name "user:ref-name", and base branch name like "master"
func (gc *GithubClient) UpdatePullRequest(org, repo string, ID int, title, body string) (*github.PullRequest, error) {
